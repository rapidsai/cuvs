...
if(NOT CUVS_HNSWLIB_GIT_TAG)
  set(CUVS_HNSWLIB_GIT_TAG v0.6.2)
endif()

if(NOT CUVS_HNSWLIB_GIT_REPOSITORY)
  set(CUVS_HNSWLIB_GIT_REPOSITORY https://github.com/nmslib/hnswlib.git)
endif()
find_and_configure_hnswlib(VERSION 0.6.2
        REPOSITORY       ${CUVS_HNSWLIB_GIT_REPOSITORY}
        PINNED_TAG       ${CUVS_HNSWLIB_GIT_TAG}
