...
function(embed_fatbins library_name kernel_target)
  ...
  set(objects_response_file ${CMAKE_CURRENT_BINARY_DIR}/${library_name}_objects.rsp)

  # Write the objects list to a response file using file(GENERATE) which handles generator expressions
  file(GENERATE
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND}
      ...
      "-DOBJECTS_RESPONSE_FILE=${objects_response_file}"
      "-DOUTPUT_DIR=${output_dir}"
      "-DSTAMP_FILE=${output_dir}/headers_generated.stamp"
  ...
  target_sources(${library_name}
    PRIVATE
    "${output_dir}/headers_generated.stamp"
    ${output_sources}
  )
