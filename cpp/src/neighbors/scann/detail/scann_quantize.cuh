...
template <uint32_t block_size, typename IdxT>
__launch_bounds__(block_size) RAFT_KERNEL
...
{
  IdxT row_idx = raft::Pow2<32>::div(IdxT{threadIdx.x} + IdxT{block_size} * IdxT{blockIdx.x});
