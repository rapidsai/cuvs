...
{
  detail::build_index<int64_t, float, int64_t, int64_t>(handle, index);
}
...
void all_knn_query(raft::resources const& handle,
                   ...
                   float weight)
{
  detail::all_knn_query<int64_t, float, int64_t, int64_t>(
    handle, index, inds, dists, k, perform_post_filtering, weight);
}
...
void eps_nn(raft::resources const& handle,
            ...
            float eps)
{
  detail::eps_nn<int64_t, float, int64_t, int64_t>(handle, index, adj, vd, query, eps);
}
...
{
  detail::eps_nn<int64_t, float, int64_t, int64_t>(
    handle, index, adj_ia, adj_ja, vd, query, eps, max_k);
}
...
void knn_query(raft::resources const& handle,
               ...
               float weight)
{
  detail::knn_query<int64_t, float, int64_t, int64_t>(
    handle, index, query, inds, dists, k, perform_post_filtering, weight);
}
