...
namespace cuvs::neighbors::ivf_flat {                                                                                \\
  ...
  {                                                                                                                  \\
    cuvs::neighbors::mg::index<ivf_flat::index<T, IdxT>, T, IdxT> index(index_params.mode, clique.get_num_ranks());  \\
  ...
  cuvs::neighbors::mg::index<ivf_flat::index<T, IdxT>, T, IdxT> deserialize<T, IdxT>(                                \\
    ...
    const std::string& filename)                                                                                     \\
  {                                                                                                                  \\
    auto idx = cuvs::neighbors::mg::index<ivf_flat::index<T, IdxT>, T, IdxT>(clique, filename);                      \\
    return idx;                                                                                                      \\
  }                                                                                                                  \\
                                                                                                                     \\
  template<>                                                                                                         \\
  cuvs::neighbors::mg::index<ivf_flat::index<T, IdxT>, T, IdxT> distribute<T, IdxT>(                                 \\
    ...
    const std::string& filename)                                                                                     \\
  {                                                                                                                  \\
    auto idx = cuvs::neighbors::mg::index<ivf_flat::index<T, IdxT>, T, IdxT>(REPLICATED, clique.get_num_ranks());    \\
...
namespace cuvs::neighbors::ivf_pq {                                                                             \\
  ...
  cuvs::neighbors::mg::index<ivf_pq::index<IdxT>, T, IdxT> build(                                               \\
    ...
    raft::host_matrix_view<const T, int64_t, row_major> index_dataset)                                          \\
  {                                                                                                             \\
    cuvs::neighbors::mg::index<ivf_pq::index<IdxT>, T, IdxT> index(index_params.mode, clique.get_num_ranks());  \\
    cuvs::neighbors::mg::detail::build(clique, index,                                                           \\
                                       static_cast<const cuvs::neighbors::index_params*>(&index_params),        \\
                                       index_dataset);                                                          \\
    return index;                                                                                               \\
  ...
  cuvs::neighbors::mg::index<ivf_pq::index<IdxT>, T, IdxT> distribute<T, IdxT>(                                 \\
    ...
    const std::string& filename)                                                                                \\
  {                                                                                                             \\
    auto idx = cuvs::neighbors::mg::index<ivf_pq::index<IdxT>, T, IdxT>(REPLICATED, clique.get_num_ranks());    \\
    cuvs::neighbors::mg::detail::deserialize_and_distribute(clique, idx, filename);                             \\
    return idx;                                                                                                 \\
  }                                                                                                             \\
}  // namespace cuvs::neighbors::ivf_pq
...
namespace cuvs::neighbors::cagra {                                                                                \\
  ...
  cuvs::neighbors::mg::index<cagra::index<T, IdxT>, T, IdxT> build(                                               \\
    ...
    raft::host_matrix_view<const T, int64_t, row_major> index_dataset)                                            \\
  {                                                                                                               \\
    cuvs::neighbors::mg::index<cagra::index<T, IdxT>, T, IdxT> index(index_params.mode, clique.get_num_ranks());  \\
    cuvs::neighbors::mg::detail::build(clique, index,                                                             \\
                                       static_cast<const cuvs::neighbors::index_params*>(&index_params),          \\
                                       index_dataset);                                                            \\
    return index;                                                                                                 \\
  ...
  cuvs::neighbors::mg::index<cagra::index<T, IdxT>, T, IdxT> deserialize<T, IdxT>(                                \\
    ...
    const std::string& filename)                                                                                  \\
  {                                                                                                               \\
    auto idx = cuvs::neighbors::mg::index<cagra::index<T, IdxT>, T, IdxT>(clique, filename);                      \\
    return idx;                                                                                                   \\
  }                                                                                                               \\
                                                                                                                  \\
  template<>                                                                                                      \\
  cuvs::neighbors::mg::index<cagra::index<T, IdxT>, T, IdxT> distribute<T, IdxT>(                                 \\
    ...
    const std::string& filename)                                                                                  \\
  {                                                                                                               \\
    auto idx = cuvs::neighbors::mg::index<cagra::index<T, IdxT>, T, IdxT>(REPLICATED, clique.get_num_ranks());    \\
    cuvs::neighbors::mg::detail::deserialize_and_distribute(clique, idx, filename);                               \\
    return idx;                                                                                                   \\
  }                                                                                                               \\
}  // namespace cuvs::neighbors::cagra
