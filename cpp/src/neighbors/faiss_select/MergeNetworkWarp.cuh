...
// This function merges raft::WarpSize / 2L lists in parallel using warp
// shuffles.
...
/// i.e., merges a sorted k/v list of size raft::WarpSize * N1 with a
/// sorted k/v list of size raft::WarpSize * N2, where N1 and N2 are any
/// value >= 1
...
/// Sort a list of raft::WarpSize * N elements in registers, where N is an
/// arbitrary >= 1
template <typename K, typename V, int N, bool Dir, typename Comp>
