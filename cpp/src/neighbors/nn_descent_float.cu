...
#define CUVS_INST_NN_DESCENT_BUILD(T, IdxT)                                                       \
  ...
  template void detail::GNND<const T, int>::build<                                                \
    cuvs::neighbors::all_neighbors::reachability::ReachabilityPostProcess<int, T>>(               \
    const T* data,                                                                                \
    const int nrow,                                                                               \
    int* output_graph,                                                                            \
    bool return_distances,                                                                        \
    float* output_distances,                                                                      \
    cuvs::neighbors::all_neighbors::reachability::ReachabilityPostProcess<int, T> dist_epilogue); \
                                                                                                  \
