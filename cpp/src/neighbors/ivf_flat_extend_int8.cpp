...
#define CUVS_INST_IVF_FLAT_EXTEND(T, IdxT)                                                            \
  ...
  {                                                                                                   \
    return raft::runtime::neighbors::ivf_flat::extend(handle, new_vectors, new_indices, orig_index);  \
  }                                                                                                   \
                                                                                                      \
  ...
  {                                                                                                   \
    raft::runtime::neighbors::ivf_flat::extend(handle, new_vectors, new_indices, idx);                \
  }
