...
#include "interleaved_scan_kernel_0_4_false_false_f_f_l_b_euclidean_4_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_0_4_false_false_f_f_l_b_euclidean_4_id()
{
  registerAlgorithm<float,
                    ...
                    cuvs::neighbors::ivf_flat::detail::euclidean_dist<4, float, float>,
                    raft::identity_op>(
    "interleaved_scan_kernel_0_4_false_false",
    embedded_interleaved_scan_kernel_0_4_false_false_f_f_l_b_euclidean_4_id,
    sizeof(embedded_interleaved_scan_kernel_0_4_false_false_f_f_l_b_euclidean_4_id));
}
