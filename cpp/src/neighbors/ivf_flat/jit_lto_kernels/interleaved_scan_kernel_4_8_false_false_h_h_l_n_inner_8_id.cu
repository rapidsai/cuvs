...
#include "interleaved_scan_kernel_4_8_false_false_h_h_l_n_inner_8_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_4_8_false_false_h_h_l_n_inner_8_id()
{
  registerAlgorithm<__half,
    ...
    embedded_interleaved_scan_kernel_4_8_false_false_h_h_l_n_inner_8_id,
    sizeof(embedded_interleaved_scan_kernel_4_8_false_false_h_h_l_n_inner_8_id));
}
