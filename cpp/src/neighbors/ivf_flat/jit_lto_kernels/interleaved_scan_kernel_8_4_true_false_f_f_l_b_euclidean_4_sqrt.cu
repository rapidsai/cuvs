...
#include "interleaved_scan_kernel_8_4_true_false_f_f_l_b_euclidean_4_sqrt.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_8_4_true_false_f_f_l_b_euclidean_4_sqrt()
{
  registerAlgorithm<float,
                    ...
                    cuvs::neighbors::ivf_flat::detail::euclidean_dist<4, float, float>,
                    raft::sqrt_op>(
    "interleaved_scan_kernel_8_4_true_false",
    embedded_interleaved_scan_kernel_8_4_true_false_f_f_l_b_euclidean_4_sqrt,
    sizeof(embedded_interleaved_scan_kernel_8_4_true_false_f_f_l_b_euclidean_4_sqrt));
}
