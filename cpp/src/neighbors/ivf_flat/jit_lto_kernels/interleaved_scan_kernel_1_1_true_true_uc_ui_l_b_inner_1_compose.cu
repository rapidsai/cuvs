...
#include "interleaved_scan_kernel_1_1_true_true_uc_ui_l_b_inner_1_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_1_1_true_true_uc_ui_l_b_inner_1_compose()
{
  registerAlgorithm<
    unsigned char,
    unsigned int,
    ...
    raft::compose_op<raft::plug_const_op<float, raft::add_op>,
                     raft::plug_const_op<float, raft::mul_op>>>(
    "interleaved_scan_kernel_1_1_true_true",
    embedded_interleaved_scan_kernel_1_1_true_true_uc_ui_l_b_inner_1_compose,
    sizeof(embedded_interleaved_scan_kernel_1_1_true_true_uc_ui_l_b_inner_1_compose));
}
