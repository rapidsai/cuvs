...
#include "interleaved_scan_kernel_32_1_false_true_sc_i_l_b_inner_1_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_32_1_false_true_sc_i_l_b_inner_1_compose()
{
  registerAlgorithm<signed char,
    ...
    embedded_interleaved_scan_kernel_32_1_false_true_sc_i_l_b_inner_1_compose,
    sizeof(embedded_interleaved_scan_kernel_32_1_false_true_sc_i_l_b_inner_1_compose));
}
