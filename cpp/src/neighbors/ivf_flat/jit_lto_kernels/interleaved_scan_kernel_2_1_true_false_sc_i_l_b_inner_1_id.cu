...
template __global__ void cuvs::neighbors::ivf_flat::detail::interleaved_scan_kernel<
  ...
  raft::identity_op>(cuvs::neighbors::ivf_flat::detail::inner_prod_dist<1, signed char, int>,
                     raft::identity_op,
                     unsigned int,
                     signed char const*,
                     unsigned int const*,
...
#include "interleaved_scan_kernel_2_1_true_false_sc_i_l_b_inner_1_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_2_1_true_false_sc_i_l_b_inner_1_id()
{
  registerAlgorithm<
    signed char,
    int,
    ...
    raft::identity_op>("interleaved_scan_kernel_2_1_true_false",
                       embedded_interleaved_scan_kernel_2_1_true_false_sc_i_l_b_inner_1_id,
                       sizeof(embedded_interleaved_scan_kernel_2_1_true_false_sc_i_l_b_inner_1_id));
}
