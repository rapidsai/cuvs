...
template __global__ void cuvs::neighbors::ivf_flat::detail::interleaved_scan_kernel<
  ...
  raft::sqrt_op>(cuvs::neighbors::ivf_flat::detail::euclidean_dist<8, __half, __half>,
                 raft::sqrt_op,
                 unsigned int,
                 __half const*,
                 unsigned int const*,
...
#include "interleaved_scan_kernel_128_8_false_false_h_h_l_b_euclidean_8_sqrt.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_128_8_false_false_h_h_l_b_euclidean_8_sqrt()
{
  registerAlgorithm<__half,
    ...
    embedded_interleaved_scan_kernel_128_8_false_false_h_h_l_b_euclidean_8_sqrt,
    sizeof(embedded_interleaved_scan_kernel_128_8_false_false_h_h_l_b_euclidean_8_sqrt));
}
