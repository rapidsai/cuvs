...
#include "interleaved_scan_kernel_256_4_true_true_f_f_l_b_inner_4_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_256_4_true_true_f_f_l_b_inner_4_compose()
{
  registerAlgorithm<float,
                    ...
                    raft::compose_op<raft::plug_const_op<float, raft::add_op>,
                                     raft::plug_const_op<float, raft::mul_op>>>(
    "interleaved_scan_kernel_256_4_true_true",
    embedded_interleaved_scan_kernel_256_4_true_true_f_f_l_b_inner_4_compose,
