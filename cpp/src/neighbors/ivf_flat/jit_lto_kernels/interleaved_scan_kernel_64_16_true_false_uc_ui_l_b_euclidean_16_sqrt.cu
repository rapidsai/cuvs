...
#include "interleaved_scan_kernel_64_16_true_false_uc_ui_l_b_euclidean_16_sqrt.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_64_16_true_false_uc_ui_l_b_euclidean_16_sqrt()
{
  registerAlgorithm<
    unsigned char,
    unsigned int,
