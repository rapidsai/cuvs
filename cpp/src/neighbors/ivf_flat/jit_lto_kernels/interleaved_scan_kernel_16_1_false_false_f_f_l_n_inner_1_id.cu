...
#include "interleaved_scan_kernel_16_1_false_false_f_f_l_n_inner_1_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_16_1_false_false_f_f_l_n_inner_1_id()
{
  registerAlgorithm<float,
    ...
    embedded_interleaved_scan_kernel_16_1_false_false_f_f_l_n_inner_1_id,
    sizeof(embedded_interleaved_scan_kernel_16_1_false_false_f_f_l_n_inner_1_id));
}
