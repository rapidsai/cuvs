...
#include "interleaved_scan_kernel_1_1_false_false_h_h_l_b_euclidean_1_sqrt.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_1_1_false_false_h_h_l_b_euclidean_1_sqrt()
{
  registerAlgorithm<__half,
    ...
    sizeof(embedded_interleaved_scan_kernel_1_1_false_false_h_h_l_b_euclidean_1_sqrt));
}
