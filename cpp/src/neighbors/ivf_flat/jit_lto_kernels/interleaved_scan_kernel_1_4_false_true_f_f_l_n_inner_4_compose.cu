...
#include "interleaved_scan_kernel_1_4_false_true_f_f_l_n_inner_4_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_1_4_false_true_f_f_l_n_inner_4_compose()
{
  registerAlgorithm<float,
    ...
    embedded_interleaved_scan_kernel_1_4_false_true_f_f_l_n_inner_4_compose,
    sizeof(embedded_interleaved_scan_kernel_1_4_false_true_f_f_l_n_inner_4_compose));
}
