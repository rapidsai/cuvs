...
#include "interleaved_scan_kernel_8_1_false_false_f_f_l_b_inner_1_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_8_1_false_false_f_f_l_b_inner_1_id()
{
  registerAlgorithm<
    float,
    float,
    ...
    raft::identity_op>("interleaved_scan_kernel_8_1_false_false",
                       embedded_interleaved_scan_kernel_8_1_false_false_f_f_l_b_inner_1_id,
