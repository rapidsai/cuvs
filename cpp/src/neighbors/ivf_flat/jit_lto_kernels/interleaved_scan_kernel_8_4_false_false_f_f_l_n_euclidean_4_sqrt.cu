...
#include "interleaved_scan_kernel_8_4_false_false_f_f_l_n_euclidean_4_sqrt.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_8_4_false_false_f_f_l_n_euclidean_4_sqrt()
{
  registerAlgorithm<float,
    ...
    embedded_interleaved_scan_kernel_8_4_false_false_f_f_l_n_euclidean_4_sqrt,
    sizeof(embedded_interleaved_scan_kernel_8_4_false_false_f_f_l_n_euclidean_4_sqrt));
}
