...
#include "interleaved_scan_kernel_0_1_false_true_uc_ui_l_b_inner_1_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_0_1_false_true_uc_ui_l_b_inner_1_compose()
{
  registerAlgorithm<
    unsigned char,
    unsigned int,
    ...
    embedded_interleaved_scan_kernel_0_1_false_true_uc_ui_l_b_inner_1_compose,
