...
template __global__ void cuvs::neighbors::ivf_flat::detail::interleaved_scan_kernel<
  ...
  raft::identity_op>(cuvs::neighbors::ivf_flat::detail::euclidean_dist<4, float, float>,
                     raft::identity_op,
                     unsigned int,
                     float const*,
                     unsigned int const*,
...
#include "interleaved_scan_kernel_32_4_false_false_f_f_l_b_euclidean_4_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_32_4_false_false_f_f_l_b_euclidean_4_id()
{
  registerAlgorithm<float,
    ...
    embedded_interleaved_scan_kernel_32_4_false_false_f_f_l_b_euclidean_4_id,
    sizeof(embedded_interleaved_scan_kernel_32_4_false_false_f_f_l_b_euclidean_4_id));
}
