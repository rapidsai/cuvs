...
#include "interleaved_scan_kernel_4_1_false_false_sc_i_l_n_euclidean_1_sqrt.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_4_1_false_false_sc_i_l_n_euclidean_1_sqrt()
{
  registerAlgorithm<signed char,
    ...
    embedded_interleaved_scan_kernel_4_1_false_false_sc_i_l_n_euclidean_1_sqrt,
