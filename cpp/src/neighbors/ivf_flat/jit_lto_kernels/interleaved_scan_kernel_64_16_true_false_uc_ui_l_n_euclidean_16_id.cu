...
#include "interleaved_scan_kernel_64_16_true_false_uc_ui_l_n_euclidean_16_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_64_16_true_false_uc_ui_l_n_euclidean_16_id()
{
  registerAlgorithm<
    unsigned char,
    unsigned int,
