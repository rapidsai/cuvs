...
#include "interleaved_scan_kernel_2_1_false_true_h_h_l_n_inner_1_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_2_1_false_true_h_h_l_n_inner_1_compose()
{
  registerAlgorithm<__half,
    ...
    embedded_interleaved_scan_kernel_2_1_false_true_h_h_l_n_inner_1_compose,
