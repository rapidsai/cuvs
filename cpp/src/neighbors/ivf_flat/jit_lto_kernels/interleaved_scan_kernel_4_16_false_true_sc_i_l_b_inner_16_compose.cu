...
#include "interleaved_scan_kernel_4_16_false_true_sc_i_l_b_inner_16_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_4_16_false_true_sc_i_l_b_inner_16_compose()
{
  registerAlgorithm<signed char,
                    ...
                    raft::compose_op<raft::plug_const_op<float, raft::add_op>,
                                     raft::plug_const_op<float, raft::mul_op>>>(
    "interleaved_scan_kernel_4_16_false_true",
    embedded_interleaved_scan_kernel_4_16_false_true_sc_i_l_b_inner_16_compose,
    sizeof(embedded_interleaved_scan_kernel_4_16_false_true_sc_i_l_b_inner_16_compose));
}
