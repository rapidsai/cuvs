...
template __global__ void cuvs::neighbors::ivf_flat::detail::interleaved_scan_kernel<
  ...
  raft::sqrt_op>(cuvs::neighbors::ivf_flat::detail::euclidean_dist<16, signed char, int>,
                 raft::sqrt_op,
                 unsigned int,
                 signed char const*,
                 unsigned int const*,
...
#include "interleaved_scan_kernel_128_16_false_false_sc_i_l_b_euclidean_16_sqrt.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_128_16_false_false_sc_i_l_b_euclidean_16_sqrt()
{
  registerAlgorithm<signed char,
    ...
    embedded_interleaved_scan_kernel_128_16_false_false_sc_i_l_b_euclidean_16_sqrt,
    sizeof(embedded_interleaved_scan_kernel_128_16_false_false_sc_i_l_b_euclidean_16_sqrt));
}
