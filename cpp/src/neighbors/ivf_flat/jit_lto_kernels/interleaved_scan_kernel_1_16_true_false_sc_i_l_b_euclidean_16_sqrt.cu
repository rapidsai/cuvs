...
#include "interleaved_scan_kernel_1_16_true_false_sc_i_l_b_euclidean_16_sqrt.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_1_16_true_false_sc_i_l_b_euclidean_16_sqrt()
{
  registerAlgorithm<signed char,
                    ...
                    cuvs::neighbors::ivf_flat::detail::euclidean_dist<16, signed char, int>,
                    raft::sqrt_op>(
    "interleaved_scan_kernel_1_16_true_false",
    embedded_interleaved_scan_kernel_1_16_true_false_sc_i_l_b_euclidean_16_sqrt,
    sizeof(embedded_interleaved_scan_kernel_1_16_true_false_sc_i_l_b_euclidean_16_sqrt));
}
