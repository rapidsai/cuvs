...
#include "interleaved_scan_kernel_32_8_true_false_h_h_l_n_euclidean_8_sqrt.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_32_8_true_false_h_h_l_n_euclidean_8_sqrt()
{
  registerAlgorithm<__half,
    ...
    embedded_interleaved_scan_kernel_32_8_true_false_h_h_l_n_euclidean_8_sqrt,
    sizeof(embedded_interleaved_scan_kernel_32_8_true_false_h_h_l_n_euclidean_8_sqrt));
}
