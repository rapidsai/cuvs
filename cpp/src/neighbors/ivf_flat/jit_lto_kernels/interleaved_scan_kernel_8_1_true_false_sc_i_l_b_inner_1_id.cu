...
#include "interleaved_scan_kernel_8_1_true_false_sc_i_l_b_inner_1_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_8_1_true_false_sc_i_l_b_inner_1_id()
{
  registerAlgorithm<
    signed char,
    int,
    ...
    raft::identity_op>("interleaved_scan_kernel_8_1_true_false",
                       ...
                       sizeof(embedded_interleaved_scan_kernel_8_1_true_false_sc_i_l_b_inner_1_id));
}
