...
#include "interleaved_scan_kernel_64_8_false_true_h_h_l_n_inner_8_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_64_8_false_true_h_h_l_n_inner_8_compose()
{
  registerAlgorithm<__half,
                    ...
                    raft::compose_op<raft::plug_const_op<float, raft::add_op>,
                                     raft::plug_const_op<float, raft::mul_op>>>(
    "interleaved_scan_kernel_64_8_false_true",
    embedded_interleaved_scan_kernel_64_8_false_true_h_h_l_n_inner_8_compose,
    sizeof(embedded_interleaved_scan_kernel_64_8_false_true_h_h_l_n_inner_8_compose));
}
