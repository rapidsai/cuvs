...
#include "interleaved_scan_kernel_2_1_false_false_uc_ui_l_n_euclidean_1_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_2_1_false_false_uc_ui_l_n_euclidean_1_id()
{
  registerAlgorithm<
    unsigned char,
    unsigned int,
    ...
    embedded_interleaved_scan_kernel_2_1_false_false_uc_ui_l_n_euclidean_1_id,
