...
#include "interleaved_scan_kernel_32_1_true_false_f_f_l_n_euclidean_1_sqrt.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_32_1_true_false_f_f_l_n_euclidean_1_sqrt()
{
  registerAlgorithm<float,
    ...
    embedded_interleaved_scan_kernel_32_1_true_false_f_f_l_n_euclidean_1_sqrt,
