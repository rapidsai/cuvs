...
template __global__ void cuvs::neighbors::ivf_flat::detail::interleaved_scan_kernel<
  ...
  raft::identity_op>(cuvs::neighbors::ivf_flat::detail::inner_prod_dist<1, float, float>,
                     raft::identity_op,
                     unsigned int,
                     float const*,
                     unsigned int const*,
...
#include "interleaved_scan_kernel_32_1_true_false_f_f_l_b_inner_1_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_32_1_true_false_f_f_l_b_inner_1_id()
{
  registerAlgorithm<
    float,
    float,
    ...
    cuvs::neighbors::filtering::
      ivf_to_sample_filter<long, cuvs::neighbors::filtering::bitset_filter<unsigned int, long>>,
    cuvs::neighbors::ivf_flat::detail::inner_prod_dist<1, float, float>,
    raft::identity_op>("interleaved_scan_kernel_32_1_true_false",
                       embedded_interleaved_scan_kernel_32_1_true_false_f_f_l_b_inner_1_id,
                       sizeof(embedded_interleaved_scan_kernel_32_1_true_false_f_f_l_b_inner_1_id));
}
