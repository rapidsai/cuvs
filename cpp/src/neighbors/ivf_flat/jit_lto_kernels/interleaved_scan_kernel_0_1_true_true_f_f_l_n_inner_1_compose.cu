...
#include "interleaved_scan_kernel_0_1_true_true_f_f_l_n_inner_1_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_0_1_true_true_f_f_l_n_inner_1_compose()
{
  registerAlgorithm<float,
    ...
    embedded_interleaved_scan_kernel_0_1_true_true_f_f_l_n_inner_1_compose,
    sizeof(embedded_interleaved_scan_kernel_0_1_true_true_f_f_l_n_inner_1_compose));
}
