...
#include "interleaved_scan_kernel_64_16_true_true_uc_ui_l_b_inner_16_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_64_16_true_true_uc_ui_l_b_inner_16_compose()
{
  registerAlgorithm<
    unsigned char,
    unsigned int,
