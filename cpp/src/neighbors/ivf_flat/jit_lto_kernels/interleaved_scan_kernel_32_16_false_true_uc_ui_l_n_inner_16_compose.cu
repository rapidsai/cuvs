...
#include "interleaved_scan_kernel_32_16_false_true_uc_ui_l_n_inner_16_compose.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_32_16_false_true_uc_ui_l_n_inner_16_compose()
{
  registerAlgorithm<
    unsigned char,
    unsigned int,
