...
#include "interleaved_scan_kernel_2_8_true_false_h_h_l_b_inner_8_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_2_8_true_false_h_h_l_b_inner_8_id()
{
  registerAlgorithm<
    __half,
    __half,
    ...
    cuvs::neighbors::filtering::
      ivf_to_sample_filter<long, cuvs::neighbors::filtering::bitset_filter<unsigned int, long>>,
    cuvs::neighbors::ivf_flat::detail::inner_prod_dist<8, __half, __half>,
    raft::identity_op>("interleaved_scan_kernel_2_8_true_false",
                       embedded_interleaved_scan_kernel_2_8_true_false_h_h_l_b_inner_8_id,
