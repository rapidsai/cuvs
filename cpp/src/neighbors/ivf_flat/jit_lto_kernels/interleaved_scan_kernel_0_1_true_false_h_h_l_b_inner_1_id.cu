...
#include "interleaved_scan_kernel_0_1_true_false_h_h_l_b_inner_1_id.h"
#include <cuvs/detail/jit_lto/RegisterKernelFragment.h>

__attribute__((__constructor__)) static void
register_interleaved_scan_kernel_0_1_true_false_h_h_l_b_inner_1_id()
{
  registerAlgorithm<
    __half,
    __half,
    ...
    raft::identity_op>("interleaved_scan_kernel_0_1_true_false",
                       embedded_interleaved_scan_kernel_0_1_true_false_h_h_l_b_inner_1_id,
                       sizeof(embedded_interleaved_scan_kernel_0_1_true_false_h_h_l_b_inner_1_id));
}
