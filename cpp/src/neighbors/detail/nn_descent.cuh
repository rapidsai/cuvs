                                  ...
                                  DistEpilogue_t dist_epilogue)
{
  ...
  // if (build_config_.metric == cuvsDistanceType::BitwiseHamming && !(std::is_same_v<Data_t,
  // uint8_t> || std::is_same_v<Data_t, int8_t>)) {
  //   RAFT_FAIL("Data type needs to be int8 or uint8 for NN Descent to run with BitwiseHamming
  //   distance.");
  // }
