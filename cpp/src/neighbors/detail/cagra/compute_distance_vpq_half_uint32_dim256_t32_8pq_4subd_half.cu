...
compute_distance_vpq<cagra_q_dataset_descriptor_t<32, 256, 8, 4, half, half, uint32_t, float>>(
  cagra_q_dataset_descriptor_t<32, 256, 8, 4, half, half, uint32_t, float>::ws_handle
    smem_workspace,
  cagra_q_dataset_descriptor_t<32, 256, 8, 4, half, half, uint32_t, float>::INDEX_T dataset_index,
  cuvs::distance::DistanceType metric,
  bool valid)
  -> cagra_q_dataset_descriptor_t<32, 256, 8, 4, half, half, uint32_t, float>::DISTANCE_T;
template <>
