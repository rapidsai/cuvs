...
compute_distance_standard<standard_dataset_descriptor_t<16, 128, half, uint64_t, float>>(
  standard_dataset_descriptor_t<16, 128, half, uint64_t, float>::ws_handle,
  standard_dataset_descriptor_t<16, 128, half, uint64_t, float>::INDEX_T,
  cuvs::distance::DistanceType,
  bool valid) -> standard_dataset_descriptor_t<16, 128, half, uint64_t, float>::DISTANCE_T;
template <>
