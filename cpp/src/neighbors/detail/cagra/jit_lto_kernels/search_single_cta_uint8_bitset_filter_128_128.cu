...
register_search_single_cta_uint8_bitset_filter_128_128()
{
  registerAlgorithm<
    cuvs::neighbors::cagra::detail::dataset_descriptor_base_t<unsigned char, unsigned int, float>,
    _128_tag,
    _128_tag>("search_single_cta_uint8_bitset_filter_128_128",
              embedded_search_single_cta_uint8_bitset_filter_128_128,
              sizeof(embedded_search_single_cta_uint8_bitset_filter_128_128));
}
