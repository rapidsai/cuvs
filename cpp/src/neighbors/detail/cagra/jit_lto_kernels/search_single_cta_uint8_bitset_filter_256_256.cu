...
register_search_single_cta_uint8_bitset_filter_256_256()
{
  registerAlgorithm<
    cuvs::neighbors::cagra::detail::dataset_descriptor_base_t<unsigned char, unsigned int, float>,
    _256_tag,
    _256_tag>("search_single_cta_uint8_bitset_filter_256_256",
              embedded_search_single_cta_uint8_bitset_filter_256_256,
              sizeof(embedded_search_single_cta_uint8_bitset_filter_256_256));
}
