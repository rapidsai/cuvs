...
__attribute__((__constructor__)) static void register_search_single_cta_uint8_bitset_filter_512_64()
{
  registerAlgorithm<
    cuvs::neighbors::cagra::detail::dataset_descriptor_base_t<unsigned char, unsigned int, float>,
    _512_tag,
    _64_tag>("search_single_cta_uint8_bitset_filter_512_64",
             embedded_search_single_cta_uint8_bitset_filter_512_64,
             sizeof(embedded_search_single_cta_uint8_bitset_filter_512_64));
}
