...
template struct instance_selector<
  ...
  standard_descriptor_spec<DistanceType::L2Expanded, 8, 128, float, uint64_t, float>,
  standard_descriptor_spec<DistanceType::InnerProduct, 8, 128, float, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 8, 128, 8, 2, half, float, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 8, 128, 8, 4, half, float, uint64_t, float>,
  standard_descriptor_spec<DistanceType::L2Expanded, 16, 256, float, uint64_t, float>,
  standard_descriptor_spec<DistanceType::InnerProduct, 16, 256, float, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 16, 256, 8, 2, half, float, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 16, 256, 8, 4, half, float, uint64_t, float>,
  standard_descriptor_spec<DistanceType::L2Expanded, 32, 512, float, uint64_t, float>,
  standard_descriptor_spec<DistanceType::InnerProduct, 32, 512, float, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 32, 512, 8, 2, half, float, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 32, 512, 8, 4, half, float, uint64_t, float>,
  standard_descriptor_spec<DistanceType::L2Expanded, 8, 128, half, uint64_t, float>,
  standard_descriptor_spec<DistanceType::InnerProduct, 8, 128, half, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 8, 128, 8, 2, half, half, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 8, 128, 8, 4, half, half, uint64_t, float>,
  standard_descriptor_spec<DistanceType::L2Expanded, 16, 256, half, uint64_t, float>,
  standard_descriptor_spec<DistanceType::InnerProduct, 16, 256, half, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 16, 256, 8, 2, half, half, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 16, 256, 8, 4, half, half, uint64_t, float>,
  standard_descriptor_spec<DistanceType::L2Expanded, 32, 512, half, uint64_t, float>,
  standard_descriptor_spec<DistanceType::InnerProduct, 32, 512, half, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 32, 512, 8, 2, half, half, uint64_t, float>,
  vpq_descriptor_spec<DistanceType::L2Expanded, 32, 512, 8, 4, half, half, uint64_t, float>>;
