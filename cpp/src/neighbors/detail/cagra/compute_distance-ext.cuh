...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 8, 128, 8, 2, half, float, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 8, 128, 8, 4, half, float, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 8, 128, 8, 4, half, float, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 16, 256, 8, 2, half, float, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 16, 256, 8, 4, half, float, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 16, 256, 8, 4, half, float, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 32, 512, 8, 2, half, float, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 32, 512, 8, 4, half, float, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 32, 512, 8, 4, half, float, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 8, 128, 8, 2, half, half, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 8, 128, 8, 4, half, half, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 8, 128, 8, 4, half, half, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 16, 256, 8, 2, half, half, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 16, 256, 8, 4, half, half, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 16, 256, 8, 4, half, half, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 32, 512, 8, 2, half, half, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 32, 512, 8, 4, half, half, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 32, 512, 8, 4, half, half, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 8, 128, 8, 2, half, int8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 8, 128, 8, 4, half, int8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 8, 128, 8, 4, half, int8_t, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 16, 256, 8, 2, half, int8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 16, 256, 8, 4, half, int8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 16, 256, 8, 4, half, int8_t, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 32, 512, 8, 2, half, int8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 32, 512, 8, 4, half, int8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 32, 512, 8, 4, half, int8_t, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 8, 128, 8, 2, half, uint8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 8, 128, 8, 4, half, uint8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 8, 128, 8, 4, half, uint8_t, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 16, 256, 8, 2, half, uint8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 16, 256, 8, 4, half, uint8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 16, 256, 8, 4, half, uint8_t, uint32_t, float>;
...
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 32, 512, 8, 2, half, uint8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded, 32, 512, 8, 4, half, uint8_t, uint32_t, float>;
extern template struct vpq_descriptor_spec<DistanceType::InnerProduct, 32, 512, 8, 4, half, uint8_t, uint32_t, float>;
