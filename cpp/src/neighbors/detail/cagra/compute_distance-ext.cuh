...
extern template struct vpq_descriptor_spec<DistanceType::L2Expanded,
                                           ...
                                           uint32_t,
                                           float>;
extern template struct standard_descriptor_spec<DistanceType::HammingUnexpanded,
                                                8,
                                                128,
                                                uint8_t,
                                                uint32_t,
...
extern template struct instance_selector<
  ...
  standard_descriptor_spec<DistanceType::HammingUnexpanded, 8, 128, uint8_t, uint32_t, float>,
  standard_descriptor_spec<DistanceType::HammingUnexpanded, 16, 256, uint8_t, uint32_t, float>,
  standard_descriptor_spec<DistanceType::HammingUnexpanded, 32, 512, uint8_t, uint32_t, float>>;
