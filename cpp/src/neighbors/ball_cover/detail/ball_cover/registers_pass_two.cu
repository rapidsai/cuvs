...
#define instantiate_cuvs_neighbors_detail_rbc_low_dim_pass_two(Mvalue_idx, Mvalue_t)             \
  template void cuvs::neighbors::ball_cover::detail::rbc_low_dim_pass_two<Mvalue_idx, Mvalue_t>( \
...
instantiate_cuvs_neighbors_detail_rbc_low_dim_pass_two(std::int64_t, float);
