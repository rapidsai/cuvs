...
index<T, IdxT>::index(raft::resources const& res,
  ...
  : cuvs::neighbors::index(),
    ...
    binary_centers_(metric != cuvs::distance::DistanceType::BitwiseHamming ? raft::make_device_matrix<uint8_t, uint32_t>(res, 0, 0) : raft::make_device_matrix<uint8_t, uint32_t>(res, n_lists, dim * 8)),
