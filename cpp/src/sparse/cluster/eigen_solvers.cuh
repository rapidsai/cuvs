...
struct lanczos_solver_t {
  ...
  auto solve_smallest_eigenvectors(
    raft::resources const& handle,
    raft::device_csr_matrix_view<value_type_t, index_type_t, index_type_t, index_type_t> input,
    value_type_t* __restrict__ eigVals,
    value_type_t* __restrict__ eigVecs) const
  {
    ...
    auto solver_iterations = raft::sparse::solver::lanczos_compute_smallest_eigenvectors(
      handle,
      lanczos_config,
      input,
      v0_opt,
