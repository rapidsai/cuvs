...
// View-type quantizer instantiations
#define CUVS_INST_QUANTIZATION_VIEW(T, QuantI)                                              \
  auto build(raft::resources const& res,                                                    \
             const params params,                                                           \
...
CUVS_INST_QUANTIZATION_VIEW(float, uint8_t);

#undef CUVS_INST_QUANTIZATION_VIEW
