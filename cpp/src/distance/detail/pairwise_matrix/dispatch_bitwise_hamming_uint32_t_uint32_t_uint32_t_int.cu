...
instantiate_raft_distance_detail_pairwise_matrix_dispatch(cuvs::distance::detail::ops::bitwise_hamming_distance_op, uint32_t, uint32_t, uint32_t, raft::identity_op, int);
