...
#include "fused_distance_nn_helpers.cuh"  // include initialize and reduce operations
...
#define instantiate_raft_distance_fusedDistanceNNMinReduce(DataT, OutT, IdxT)       \
  extern template void cuvs::distance::fusedDistanceNNMinReduce<DataT, OutT, IdxT>( \
    OutT * min,                                                                     \
    const DataT* x,                                                                 \
    const DataT* y,                                                                 \
    const DataT* xn,                                                                \
