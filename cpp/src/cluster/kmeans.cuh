...
using sampling_op = cuvs::cluster::kmeans::detail::sampling_op<DataT, IndexT>;
...
using key_value_index_op = cuvs::cluster::kmeans::detail::key_value_index_op<IndexT, DataT>;
...
void sample_centroids(raft::resources const& handle,
                      ...
                      rmm::device_uvector<char>& workspace)
{
  cuvs::cluster::kmeans::detail::sample_centroids<DataT, IndexT>(
...
void min_cluster_distance(raft::resources const& handle,
                          ...
                          rmm::device_uvector<char>& workspace)
{
  cuvs::cluster::kmeans::detail::min_cluster_distance_compute<DataT, IndexT>(handle,
                                                                             X,
                                                                             centroids,
                                                                             minClusterDistance,
                                                                             L2NormX,
