...
// predict_batched implementations
void predict_batched(raft::resources const& handle,
                     ...
                     raft::host_scalar_view<float> inertia)
{
  cuvs::cluster::kmeans::detail::predict<uint8_t, float, int64_t>(handle,
                                                                  params,
                                                                  X,
                                                                  batch_size,
                                                                  sample_weight,
...
void predict_batched(raft::resources const& handle,
                     ...
                     raft::host_scalar_view<float> inertia)
{
  cuvs::cluster::kmeans::detail::predict<int8_t, float, int64_t>(handle,
                                                                 params,
                                                                 X,
                                                                 batch_size,
                                                                 sample_weight,
...
void predict_batched(raft::resources const& handle,
                     ...
                     raft::host_scalar_view<float> inertia)
{
  cuvs::cluster::kmeans::detail::predict<half, float, int64_t>(handle,
                                                               params,
                                                               X,
                                                               batch_size,
                                                               sample_weight,
...
// fit_predict_batched implementations
void fit_predict_batched(raft::resources const& handle,
                         ...
                         raft::host_scalar_view<int64_t> n_iter)
{
  cuvs::cluster::kmeans::detail::fit_predict<uint8_t, float, int64_t>(handle,
                                                                      params,
                                                                      X,
                                                                      batch_size,
                                                                      sample_weight,
...
void fit_predict_batched(raft::resources const& handle,
                         ...
                         raft::host_scalar_view<int64_t> n_iter)
{
  cuvs::cluster::kmeans::detail::fit_predict<int8_t, float, int64_t>(handle,
                                                                     params,
                                                                     X,
                                                                     batch_size,
                                                                     sample_weight,
...
void fit_predict_batched(raft::resources const& handle,
                         ...
                         raft::host_scalar_view<int64_t> n_iter)
{
  cuvs::cluster::kmeans::detail::fit_predict<half, float, int64_t>(handle,
                                                                   params,
                                                                   X,
                                                                   batch_size,
                                                                   sample_weight,
