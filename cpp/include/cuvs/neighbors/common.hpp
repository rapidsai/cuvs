...
/**
 * @brief VPQ compressed dataset - base interface.
 *
 ...
 *
 * This is the abstract base class. Use vpq_dataset_owning for owning data
 * or vpq_dataset_view for non-owning views.
 *
...
/**
 * @brief Owning VPQ dataset - owns the codebooks and data.
 *
 * @tparam MathT the type of elements in the codebooks
 * @tparam IdxT type of the vector indices
 */
template <typename MathT, typename IdxT>
struct vpq_dataset_owning : public vpq_dataset<MathT, IdxT> {
  using index_type = IdxT;
  using math_type  = MathT;
...
/**
 * @brief View-type VPQ dataset - non-owning views to external data.
 *
 ...
 */
template <typename MathT, typename IdxT>
struct vpq_dataset_view : public vpq_dataset<MathT, IdxT> {
  using index_type = IdxT;
  using math_type  = MathT;
