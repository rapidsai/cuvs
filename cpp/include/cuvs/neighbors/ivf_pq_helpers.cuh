                     ...
                     raft::device_matrix_view<float> cluster_centers)
{
  ...
  auto stream = resource::get_cuda_stream(res);
  CUVS_CUDA_TRY(cudaMemcpy2DAsync(cluster_centers.data_handle(),
