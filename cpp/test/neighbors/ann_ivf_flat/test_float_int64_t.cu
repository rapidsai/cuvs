...
TEST_P(AnnIVFFlatTestF_float, AnnIVFFlat) { this->testIVFFlat(); }
...
TEST_P(AnnIVFFlatTestF_cosine_float, AnnIVFFlat) { this->testIVFFlatCosine(); }
INSTANTIATE_TEST_CASE_P(AnnIVFFlatTest,
                        AnnIVFFlatTestF_cosine_float,
