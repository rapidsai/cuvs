...
using DistanceRussellRaoF = DistanceRussellRao<float>;
...
using DistanceRussellRaoD = DistanceRussellRao<double>;
...
using DistanceRussellRaoH = DistanceRussellRao<half, float>;
...
TEST_F(BigMatrixRussellRao, Result) {}  // NOLINT(modernize-use-trailing-return-type)
}  // namespace cuvs::distance
