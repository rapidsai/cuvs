...
using DistanceLpUnexpF = DistanceLpUnexp<float>;  // NOLINT(readability-identifier-naming)
...
using DistanceLpUnexpD = DistanceLpUnexp<double>;  // NOLINT(readability-identifier-naming)
...
using DistanceLpUnexpH = DistanceLpUnexp<half, float>;  // NOLINT(readability-identifier-naming)
