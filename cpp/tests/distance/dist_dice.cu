...
class DistanceExpDice : public DistanceTest<cuvs::distance::DistanceType::DiceExpanded, DataType> {
};

template <typename DataType>
class DistanceExpDiceXequalY
  : public DistanceTestSameBuffer<cuvs::distance::DistanceType::DiceExpanded, DataType> {};
