...
class DistanceJensenShannon  // NOLINT(readability-identifier-naming)
...
typedef DistanceJensenShannon<float>
  DistanceJensenShannonF;  // NOLINT(modernize-use-using,readability-identifier-naming)
...
typedef DistanceJensenShannon<double>
  DistanceJensenShannonD;  // NOLINT(modernize-use-using,readability-identifier-naming)
...
typedef DistanceJensenShannon<half, float>
  DistanceJensenShannonH;  // NOLINT(modernize-use-using,readability-identifier-naming)
...
class BigMatrixJensenShannon  // NOLINT(readability-identifier-naming)
