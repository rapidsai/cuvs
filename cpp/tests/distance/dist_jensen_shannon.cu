...
using DistanceJensenShannonF = DistanceJensenShannon<float>;  // NOLINT(readability-identifier-naming)
...
using DistanceJensenShannonD = DistanceJensenShannon<double>;  // NOLINT(readability-identifier-naming)
...
using DistanceJensenShannonH = DistanceJensenShannon<half, float>;  // NOLINT(readability-identifier-naming)
