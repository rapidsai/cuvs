...
using DistanceHammingF = DistanceHamming<float>;
...
using DistanceHammingD = DistanceHamming<double>;
...
using DistanceHammingH = DistanceHamming<half, float>;
...
TEST_F(BigMatrixHamming, Result) {}  // NOLINT(modernize-use-trailing-return-type)
}  // namespace cuvs::distance
