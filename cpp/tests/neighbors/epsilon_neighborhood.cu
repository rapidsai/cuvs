...
template <typename T, typename IdxT>
auto operator<<(::std::ostream& os, const EpsInputs<T, IdxT>& p) -> ::std::ostream&
{
  return os;
}
...
using EpsNeighTestFI = EpsNeighTest<float, int64_t>;

TEST_P(EpsNeighTestFI,
       ResultBruteForce)  // NOLINT(modernize-use-trailing-return-type)
{
...
INSTANTIATE_TEST_CASE_P(
  EpsNeighTests,
  EpsNeighTestFI,
  ::testing::ValuesIn(kInputsfi));  // NOLINT(modernize-use-trailing-return-type)
...
using EpsNeighRbcTestFI = EpsNeighTest<float, int64_t>;

TEST_P(EpsNeighRbcTestFI,
       DenseRbc)  // NOLINT(modernize-use-trailing-return-type)
{
...
TEST_P(EpsNeighRbcTestFI,
       SparseRbc)  // NOLINT(modernize-use-trailing-return-type)
{
...
TEST_P(EpsNeighRbcTestFI,
       SparseRbcMaxK)  // NOLINT(modernize-use-trailing-return-type)
{
  auto adj_ia          = raft::make_device_vector<int64_t>(handle, batchSize + 1);
  auto adj_ja          = raft::make_device_vector<int64_t>(handle, param.n_row * batchSize);
  auto vd_baseline     = raft::make_device_vector<int64_t>(handle, batchSize + 1);
...
INSTANTIATE_TEST_CASE_P(
  EpsNeighTests,
  EpsNeighRbcTestFI,
  ::testing::ValuesIn(kInputsfiRbc));  // NOLINT(modernize-use-trailing-return-type)
