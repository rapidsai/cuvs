...
using AnnCagraTestF_U32 = AnnCagraTest<float, float, std::uint32_t>;
...
using AnnCagraAddNodesTestF_U32 = AnnCagraAddNodesTest<float, float, std::uint32_t>;
...
using AnnCagraFilterTestF_U32 = AnnCagraFilterTest<float, float, std::uint32_t>;
...
using AnnCagraIndexMergeTestF_U32 = AnnCagraIndexMergeTest<float, float, std::uint32_t>;
...
using AnnCagraIndexFilteredMergeTestF_U32 =
  AnnCagraIndexFilteredMergeTest<float, float, std::uint32_t>;
TEST_P(
  AnnCagraIndexFilteredMergeTestF_U32,  // NOLINT(google-readability-avoid-underscore-in-googletest-name)
  AnnCagraIndexFilteredMerge_U32)  // NOLINT(google-readability-avoid-underscore-in-googletest-name)
{
  this->testCagra<uint32_t>();
}
