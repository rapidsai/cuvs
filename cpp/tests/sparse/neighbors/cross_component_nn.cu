...
//
// TODO(cuvs-build): consider adding this to libraft.so or creating an instance in a
// separate translation unit for this test.
//
// TODO(cuvs-test): edge case testing. Reference: https://github.com/rapidsai/raft/issues/1669
...
using ConnectComponentsTestF_Int = ConnectComponentsTest<int, float>;
TEST_P(
...
using ConnectComponentsEdgesTestF_Int = ConnectComponentsEdgesTest<int, float>;
