...
INSTANTIATE_TEST_CASE_P(
  ConnectComponentsTest,  // NOLINT(modernize-use-trailing-return-type,readability-identifier-naming)
...
INSTANTIATE_TEST_CASE_P(
  ConnectComponentsEdgesTest,  // NOLINT(modernize-use-trailing-return-type,readability-identifier-naming)
