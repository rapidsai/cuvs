    ...
    def test_backend_config_custom_values(self):
        ...
        try:
            ...
            config = {
                ...
                "output_filename": ("cuvs_ivf_flat,test", "cuvs_ivf_flat,test,k10,bs1000"),
                "algo": "cuvs_ivf_flat"
            }
            backend = CppGoogleBenchmarkBackend(config)
            ...
            assert backend.output_filename == ("cuvs_ivf_flat,test", "cuvs_ivf_flat,test,k10,bs1000")
...
class TestCppBackendBuildSearch:
    ...
    def test_search_dry_run(self):
        ...
        try:
            ...
            assert result.metadata.get("dry_run") is True
            assert result.metadata.get("num_indexes") == 1
            assert result.metadata.get("total_search_configs") == 2  # 2 search params
