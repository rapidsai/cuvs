...
public class cuvsCagraSearchParams {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        PanamaFFMAPI.C_LONG.withName("max_queries"),
        PanamaFFMAPI.C_LONG.withName("itopk_size"),
        PanamaFFMAPI.C_LONG.withName("max_iterations"),
        PanamaFFMAPI.C_INT.withName("algo"),
        MemoryLayout.paddingLayout(4),
        PanamaFFMAPI.C_LONG.withName("team_size"),
        PanamaFFMAPI.C_LONG.withName("search_width"),
        PanamaFFMAPI.C_LONG.withName("min_iterations"),
        PanamaFFMAPI.C_LONG.withName("thread_block_size"),
        PanamaFFMAPI.C_INT.withName("hashmap_mode"),
        MemoryLayout.paddingLayout(4),
        PanamaFFMAPI.C_LONG.withName("hashmap_min_bitlen"),
        PanamaFFMAPI.C_FLOAT.withName("hashmap_max_fill_rate"),
        PanamaFFMAPI.C_INT.withName("num_random_samplings"),
        PanamaFFMAPI.C_LONG.withName("rand_xor_mask")
