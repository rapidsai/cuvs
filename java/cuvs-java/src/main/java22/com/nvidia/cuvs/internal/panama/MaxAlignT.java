...
public class MaxAlignT {
  ...
  private static final GroupLayout $LAYOUT = MemoryLayout
      .structLayout(CagraH.C_LONG_LONG.withName("__clang_max_align_nonce1"), MemoryLayout.paddingLayout(24))
      .withName("$anon$19:9");
  ...
  private static final OfLong __clang_max_align_nonce1$LAYOUT = (OfLong) $LAYOUT
      .select(groupElement("__clang_max_align_nonce1"));

  /**
   * Layout for field:
   * {@snippet lang = c : * long long __clang_max_align_nonce1
   * }
   */
