...
public class cudaHostFn_t {
    ...
    private static final MethodHandle UP$MH = PanamaFFMAPI.upcallHandle(cudaHostFn_t.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(cudaHostFn_t.Function fi, Arena arena) {
