...
public class DLManagedTensorVersioned {
  ...
  private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(DLPackVersion.layout().withName("version"),
      DlpackH.C_POINTER.withName("manager_ctx"), DlpackH.C_POINTER.withName("deleter"),
      DlpackH.C_LONG.withName("flags"), DLTensor.layout().withName("dl_tensor")).withName("DLManagedTensorVersioned");
  ...
  /**
   * Layout for field:
   * {@snippet lang = c : * DLPackVersion version
   * }
   */
  ...
  /**
   * Layout for field:
   * {@snippet lang = c : * void *manager_ctx
   * }
   */
  ...
  /**
   * {@snippet lang = c : * void (*deleter)(struct DLManagedTensorVersioned *)
   * }
   */
  public static class deleter {
    ...
    private static final FunctionDescriptor $DESC = FunctionDescriptor.ofVoid(DlpackH.C_POINTER);
  ...
  /**
   * Layout for field:
   * {@snippet lang = c : * DLTensor dl_tensor
   * }
   */
