...
public class ulong4 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        PanamaFFMAPI.C_LONG.withName("x"),
        PanamaFFMAPI.C_LONG.withName("y"),
        PanamaFFMAPI.C_LONG.withName("z"),
        PanamaFFMAPI.C_LONG.withName("w")
    ).withName("ulong4");
    ...
    private static final OfLong z$LAYOUT = (OfLong)$LAYOUT.select(groupElement("z"));
     ...
     * }
     */
    public static long z(MemorySegment struct) {
     ...
     * }
     */
    public static void z(MemorySegment struct, long fieldValue) {
        struct.set(z$LAYOUT, z$OFFSET, fieldValue);
    }

    private static final OfLong w$LAYOUT = (OfLong)$LAYOUT.select(groupElement("w"));
     ...
     * }
     */
    public static long w(MemorySegment struct) {
     ...
     * }
     */
    public static void w(MemorySegment struct, long fieldValue) {
