...
public class char4 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        PanamaFFMAPI.C_CHAR.withName("x"),
        PanamaFFMAPI.C_CHAR.withName("y"),
        PanamaFFMAPI.C_CHAR.withName("z"),
        PanamaFFMAPI.C_CHAR.withName("w")
    ).withName("char4");
     ...
     * }
     */
    public static byte z(MemorySegment struct) {
     ...
     * }
     */
    public static void z(MemorySegment struct, byte fieldValue) {
