...
public class DLDevice {
  ...
  private static final GroupLayout $LAYOUT = MemoryLayout
      .structLayout(CagraH.C_INT.withName("device_type"), CagraH.C_INT.withName("device_id")).withName("$anon$97:9");
  ...
  /**
   * Layout for field:
   * {@snippet lang = c : * DLDeviceType device_type
   * }
   */
  ...
  /**
   * Layout for field:
   * {@snippet lang = c : * int32_t device_id
   * }
   */
