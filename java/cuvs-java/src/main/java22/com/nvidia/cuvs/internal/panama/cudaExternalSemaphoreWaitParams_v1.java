 ...
 * }
 */
public class cudaExternalSemaphoreWaitParams_v1 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cudaExternalSemaphoreWaitParams_v1.params.layout().withName("params"),
        PanamaFFMAPI.C_INT.withName("flags"),
        MemoryLayout.paddingLayout(4)
    ).withName("cudaExternalSemaphoreWaitParams_v1");
    ...
    public static class params {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            cudaExternalSemaphoreWaitParams_v1.params.fence.layout().withName("fence"),
            cudaExternalSemaphoreWaitParams_v1.params.nvSciSync.layout().withName("nvSciSync"),
            cudaExternalSemaphoreWaitParams_v1.params.keyedMutex.layout().withName("keyedMutex")
        ).withName("$anon$2739:5");
