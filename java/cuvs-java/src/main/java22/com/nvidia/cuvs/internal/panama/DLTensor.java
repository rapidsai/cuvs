...
public class DLTensor {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        PanamaFFMAPI.C_POINTER.withName("data"),
        DLDevice.layout().withName("device"),
        PanamaFFMAPI.C_INT.withName("ndim"),
        DLDataType.layout().withName("dtype"),
        PanamaFFMAPI.C_POINTER.withName("shape"),
        PanamaFFMAPI.C_POINTER.withName("strides"),
        PanamaFFMAPI.C_LONG.withName("byte_offset")
    ).withName("$anon$163:9");
