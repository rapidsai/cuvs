...
public class cuvsIvfPqSearchParams {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        PanamaFFMAPI.C_INT.withName("n_probes"),
        PanamaFFMAPI.C_INT.withName("lut_dtype"),
        PanamaFFMAPI.C_INT.withName("internal_distance_dtype"),
        MemoryLayout.paddingLayout(4),
        PanamaFFMAPI.C_DOUBLE.withName("preferred_shmem_carveout")
    ...
    private static final OfInt internal_distance_dtype$LAYOUT = (OfInt)$LAYOUT.select(groupElement("internal_distance_dtype"));
    ...
    private static final OfDouble preferred_shmem_carveout$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("preferred_shmem_carveout"));
