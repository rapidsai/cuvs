 ...
 * }
 */
public class cudaExternalSemaphoreWaitParams {
    ...
    public static class params {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            cudaExternalSemaphoreWaitParams.params.fence.layout().withName("fence"),
            cudaExternalSemaphoreWaitParams.params.nvSciSync.layout().withName("nvSciSync"),
            cudaExternalSemaphoreWaitParams.params.keyedMutex.layout().withName("keyedMutex"),
            MemoryLayout.sequenceLayout(10, PanamaFFMAPI.C_INT).withName("reserved")
        ).withName("$anon$2835:5");
        ...
        public static class keyedMutex {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                ...
                PanamaFFMAPI.C_INT.withName("timeoutMs"),
                MemoryLayout.paddingLayout(4)
            ...
            private static final OfInt timeoutMs$LAYOUT = (OfInt)$LAYOUT.select(groupElement("timeoutMs"));
             ...
             * }
             */
            public static final OfInt timeoutMs$layout() {
                return timeoutMs$LAYOUT;
            }

            private static final long timeoutMs$OFFSET = 8;
             ...
             * }
             */
            public static final long timeoutMs$offset() {
                return timeoutMs$OFFSET;
            }
             ...
             * }
             */
            public static int timeoutMs(MemorySegment struct) {
                return struct.get(timeoutMs$LAYOUT, timeoutMs$OFFSET);
            }
             ...
             * }
             */
            public static void timeoutMs(MemorySegment struct, int fieldValue) {
                struct.set(timeoutMs$LAYOUT, timeoutMs$OFFSET, fieldValue);
            }
