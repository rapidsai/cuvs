...
public class DLManagedTensor {
  ...
  private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(DLTensor.layout().withName("dl_tensor"),
  ...
  /**
   * {@snippet lang = c : * void (*deleter)(struct DLManagedTensor *)
   * }
   */
  public static class deleter {
    ...
    private static final FunctionDescriptor $DESC = FunctionDescriptor.ofVoid(CagraH.C_POINTER);
    ...
    private static final MethodHandle UP$MH = CagraH.upcallHandle(deleter.Function.class, "apply", $DESC);
