...
public class DLManagedTensor {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        PanamaFFMAPI.C_POINTER.withName("manager_ctx"),
        PanamaFFMAPI.C_POINTER.withName("deleter")
    ...
    public static class deleter {
        ...
        private static final MethodHandle UP$MH = PanamaFFMAPI.upcallHandle(deleter.Function.class, "apply", $DESC);
