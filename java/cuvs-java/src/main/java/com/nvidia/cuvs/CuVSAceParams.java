...
public class CuVSAceParams {
  ...
  private CuVSAceParams(int aceNpartitions, int aceEfConstruction, String aceBuildDir, boolean aceUseDisk) {
  ...
  public String toString() {
    return "CuVSAceParams [aceNpartitions="
        + aceNpartitions
        + ", aceEfConstruction="
        + aceEfConstruction
        + ", aceBuildDir="
  ...
  public static class Builder {
    ...
    public CuVSAceParams build() {
      return new CuVSAceParams(aceNpartitions, aceEfConstruction, aceBuildDir, aceUseDisk);
    }
  }
}
