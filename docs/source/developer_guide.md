...
3. Disable reflowing of comments.
   The reasons behind these deviations from the Google style guide are given in comments [here](https://github.com/rapidsai/raft/blob/branch-25.04/cpp/.clang-format).
...
### #include style
[include_checker.py](https://github.com/rapidsai/raft/blob/branch-25.04/cpp/scripts/include_checker.py) is used to enforce the include style as follows:
