...
export CGO_LDFLAGS="-L${CONDA_PREFIX}/lib -lcudart_static -lcuvs -lcuvs_c -ldl"
...
```bash
go get github.com/rapidsai/cuvs/go@v26.04.00 # 25.02.00 being your desired version, selected from https://github.com/rapidsai/cuvs/tags
```
