...
For custom benchmark execution paths and backend integrations, see [Backends](/user-guide/benchmarking-guide/cu-vs-bench-tool/backends).

For setup, see [Installation](/user-guide/benchmarking-guide/cu-vs-bench-tool/installation). To run benchmark workflows, see [Usage](/user-guide/benchmarking-guide/cu-vs-bench-tool/usage). To compile the benchmark executables locally, see [Build from Source](/user-guide/benchmarking-guide/cu-vs-bench-tool/installation#build-from-source).
