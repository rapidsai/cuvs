...
When the composite index contains multiple sub-indices, the user can set a stream pool in the input raft::resource to enable parallel search across sub-indices for improved performance. Usage example:
