...
message(STATUS "_rapids_version: ${_rapids_version}")
message(STATUS "RAPIDS_USE_MAIN: ${RAPIDS_USE_MAIN}")
message(FATAL_ERROR "rapids-cmake-branch: ${rapids-cmake-branch}")
